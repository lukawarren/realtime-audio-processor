...
% Footer with name on it %
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[R]{\raggedleft Luka Warren, candidate 2312, centre 45006\hfill}
...
\begin{document}
	...
	\subsection*{Final Showcase}
	Final evidence of the project's completion can be viewed
	...
	}, showcasing the fulfilment  of all the project's objectives. This is also alluded to in the "testing" and "evaluation" sections of this document, though repeated here for the convenience of the reader.
