...
\paragraph{Test 7.3} Speeding up audio playback does not significantly increase the computational overhead
\paragraph{Test 7.4} Slowing down audio playback does not significantly increase the computational overhead
