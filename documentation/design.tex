...
\begin{itemize}
	...
	\item Audio files also contain other crucial information, such as the audio frequency (e.g. 44,000 Hz), the number of channels (usually mono (1) or stereo (2)), and the number of samples.
...
\begin{enumerate}
	...
	\item The AudioStream used SDL2 to invoke audio playback at regular intervals on a separate thread (the "audio thread") using a callback
...
TODO:
- add flowchart for that in summary section
- create summary section with UML for AudioFile, AudioStream and Playlist and flowchart for streaming
...
\begin{itemize}
	...
	\item talk about wxwidgets in GUI part
\end{itemize}