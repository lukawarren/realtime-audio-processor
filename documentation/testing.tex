	...
	\begin{table}[h!]
		\begin{center}
			\begin{tabularx}{1.0 \textwidth} {
				...
				\hline
				5.2 & "The echo effect can have its various parameters modified, which results in a correct change in te audio playback." & \fullpageref{sec:evidence5.2} & Yes\\
...
\paragraph{}
{
	\centering
	\fbox{\begin{minipage}{15cm}
			" The echo effect can have its various parameters modified, which results in a correct change in te audio playback."
	\end{minipage}}
}
